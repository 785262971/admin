    ...
    var ms = {
        ...
        fillHtml:function(totalsubpageTmep,args){
            return (function(){
                ...
                totalsubpageTmep += "<li><a>共<font color=\"red\">"+args.rowCount+"</font>条</a></li>";
                var gopage = 1;
				...
				totalsubpageTmep += ("<li><input type=\"number\" value=\""+gopage+"\" id=\"page_no\" min=\"1\" max='"+args.totalPage+"' style=\"width:50px;text-align:center;float:left\" placeholder=\"页码\"></li>");
				totalsubpageTmep += "<li style=\"cursor:pointer;\"><a onclick=\"javascript:;\" id=\"btnConfirm\" class=\"btn btn-mini btn-primary\">跳转</a></li>";
                ...
                //totalsubpageTmep +="<li><a href=\"javascript:;\" class=\"geraltTb_\" id=\"btnConfirm\">确定</a></li>";
                	...
                	totalsubpageTmep +="<span style='color:red;margin-right: 500px; font-weight:blod;'></span>";
                }
                totalsubpageTmep +="</ul>";
        ...
        gopage:function(totalsubpageTmep,args){
            totalsubpageTmep.on("click","#btnConfirm",function(event){
            	if($("#page_no").val()!=null&&$("#page_no").val()!=""){
